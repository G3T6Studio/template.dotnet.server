...
static void ConfigureServices(WebApplicationBuilder builder)
{
    ...
    builder.Services.ConfigureHttpJsonOptions(options =>
    {
        ...
        options.SerializerOptions.TypeInfoResolverChain.Add(IdentityMinimalApisJsonSerializerContext.Default);
    });
    ...
    // 配置管理后台身份认证
    builder.Services.AddACUserManager2<AppSettings, AppDbContext>();
...
static void Configure(WebApplication app)
{
    ...
    // 配置微服务终结点路由
    app.MapIdentityMinimalApis<AppSettings, AppDbContext>();
